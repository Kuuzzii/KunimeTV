...
async function setupServers() {
  ...
  if (type === 'movie') {
    servers.push(
      ...
      { name: 'Server 7', url: `https://vidcloud.stream/${movieId}.html` },
      { name: 'Server 8', url: `https://vidlink.pro/movie/${movieId}` },
      { name: 'Server 9', url: `https://vidsrc.dev/embed/movie/${movieId}` },
      { name: 'Server 10', url: `https://111movies.com/movie/${movieId}` },
      { name: 'Server 11', url: `https://vidjoy.pro/embed/movie/${movieId}` },
      { name: 'Server 12', url: `https://vidsrc.io/embed/movie/${movieId}` },
      { name: 'Server 13', url: `https://vidsrc.cc/v2/embed/movie/${movieId}` },
      { name: 'Server 14', url: `https://vidsrc.xyz/embed/movie/${movieId}` },
      { name: 'Server 15', url: `https://www.2embed.cc/embed/${movieId}` },
